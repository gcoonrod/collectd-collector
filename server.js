    ...
    self.createRoutes = function() {
        ...
        self.routes['/data'] = function(req, res) {
            ...
            fs.exists(json_file, function(exists){
                if(exists){
                    fs.stat(json_file, function(error, stats){
                        fs.open(json_file, "r", function(error, fd){
    ...
    self.initializeServer = function() {
        ...
        self.app.post('*', function(req, res){
            ...
            if(json === undefined || req.body === undefined){
                fs.writeFile("json/error.txt", req.toString(), function(error){
